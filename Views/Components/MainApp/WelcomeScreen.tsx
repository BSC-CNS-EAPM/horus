...
function OpenMolstar() {
  return (
    <HorusLink to="/flow?molstar&smiles">
      <HorusContainer
        className="zoom-on-hover"
        style={{
          cursor: "pointer"
...
function OpenFlow() {
  return (
    <HorusLink to="/flow?open=true&flowID=open">
      <HorusContainer
        className="zoom-on-hover"
        style={{
          cursor: "pointer"
...
function PredefinedFlowsSplash() {
  ...
  const { isLoading: fetchingRecents, presetFlows: predefinedFlows } =
    useGetRecentFlows();
