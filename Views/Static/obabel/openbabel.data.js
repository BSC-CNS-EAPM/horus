...
(function () {
  var loadPackage = function (metadata) {
    ...
    var PACKAGE_NAME = "../bin/openbabel.data";
    var REMOTE_PACKAGE_BASE = "openbabel.data";
    if (
    ...
    function runWithFS() {
      ...
      function processPackageData(arrayBuffer) {
        ...
        Module["removeRunDependency"]("datafile_../bin/openbabel.data");
      }
      Module["addRunDependency"]("datafile_../bin/openbabel.data");
    ...
    files: [
      {
        ...
        filename: "/data/rigid-fragments-index.txt",
      },
      {
        start: 157957,
        audio: 0,
        end: 2094833,
        filename: "/data/rigid-fragments.txt",
      },
      {
        start: 2094833,
        audio: 0,
        end: 2853362,
        filename: "/data/ring-fragments.txt",
      },
    ],
    remote_package_size: 2853362,
    package_uuid: "5d2c8d72-a892-4bc6-a9f4-b40e2a81ad10",
  });
})();
